...
def upgrade() -> None:
    ...
    sa.Column('font_size', sa.Enum('SMALL', 'MEDIUM', 'LARGE', name='fontsize'), nullable=False),
    ...
    op.create_index(op.f('ix_users_microsoft_id'), 'users', ['microsoft_id'], unique=False)
    ...
    sa.Column('message_type', sa.Enum('TEXT', 'SYSTEM', 'ARTICLE_SHARE', 'FEED_ADD', name='chat_message_type_enum'), server_default='TEXT', nullable=False),
    ...
    sa.ForeignKeyConstraint(['reply_to_id'], ['chat_messages.id'], name=op.f('fk_chat_messages_reply_to_id_chat_messages')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_chat_messages'))
    )
    op.create_index(op.f('ix_chat_messages_author_id'), 'chat_messages', ['author_id'], unique=False)
    op.create_index(op.f('ix_chat_messages_collection_id'), 'chat_messages', ['collection_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['invited_by'], ['users.id'], name=op.f('fk_collection_members_invited_by_users')),
    ...
    op.create_index(op.f('ix_collection_members_invitation_token'), 'collection_members', ['invitation_token'], unique=False)
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'ERROR', 'DELETED', name='feedstatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['created_by'], ['users.id'], name=op.f('fk_feeds_created_by_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_feeds'))
    )
    op.create_index(op.f('ix_feeds_collection_id'), 'feeds', ['collection_id'], unique=False)
    ...
    sa.Column('file_format', sa.Enum('OPML', 'JSON', 'CSV', name='fileformat'), nullable=False),
    sa.Column('file_size', sa.Integer(), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'CANCELLED', name='importstatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['target_collection_id'], ['collections.id'], name=op.f('fk_import_jobs_target_collection_id_collections')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_import_jobs_user_id_users')),
    ...
    op.create_index('ix_articles_guid_feed', 'articles', ['guid', 'feed_id'], unique=True)
    ...
    op.create_index(op.f('ix_feed_categories_category_id'), 'feed_categories', ['category_id'], unique=False)
    op.create_index(op.f('ix_feed_categories_feed_id'), 'feed_categories', ['feed_id'], unique=False)
    op.create_index(op.f('ix_feed_categories_id'), 'feed_categories', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_user_articles_article_id'), 'user_articles', ['article_id'], unique=False)
    op.create_index('ix_user_articles_favorite', 'user_articles', ['user_id', 'is_favorite'], unique=False)
    op.create_index(op.f('ix_user_articles_id'), 'user_articles', ['id'], unique=False)
    op.create_index('ix_user_articles_read', 'user_articles', ['user_id', 'is_read'], unique=False)
    op.create_index('ix_user_articles_unique', 'user_articles', ['user_id', 'article_id'], unique=True)
    op.create_index(op.f('ix_user_articles_user_id'), 'user_articles', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_collection_members_invitation_token'), table_name='collection_members')
